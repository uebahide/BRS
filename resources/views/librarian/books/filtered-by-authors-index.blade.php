        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                  <div class="text-2xl mb-6 shadow text-center rounded">authors search : {{$authors}}</div>
                    <div class="flex flex-wrap">
                      @foreach ($books as $book)
                          
                      <div class="lg:w-1/2 lg:mx-0 sm:mx-auto">
                        <form action="{{route('librarian.books.show', ['book' => $book->id])}}" method="GET" class="flex flex-col items-start bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 min-h-80">
                          @csrf
