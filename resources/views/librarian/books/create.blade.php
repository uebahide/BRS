              ...
              <div class="p-6 text-gray-900">
                  ...
                  <div class="grid gap-6 mb-6 md:grid-cols-2">
                      ...
                      <div>
                        ...
                        pattern="^(?=(?:\D*\d){10}(?:(?:\D*\d){3})?$)[\d-]+$" placeholder="https:/*.*:**/***/***/***" value="{{old('cover_image')}}"/>
