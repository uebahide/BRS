      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
          <div class="overflow-hidden shadow-sm sm:rounded-lg">
              <div class="p-6 text-gray-900 w-2/3 mx-auto">
                <div class=" text-xl sm:text-2xl mb-6 shadow text-center rounded">Archived Genre list</div>
                <div class="mx-auto text-surface dark:text-white">
                  @foreach ($genres as $genre)
                    <div class="flex flex-col sm:flex-row mb-4 items-center justify-center">
